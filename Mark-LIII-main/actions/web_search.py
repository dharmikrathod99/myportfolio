...
def _gemini_search(query: str) -> str:
    ...
    try:
        ...
        # Fall back to high-quota factual model if google_search grounding is rate-limited
        response = client.models.generate_content(
            model="gemini-3.1-flash-lite",
            contents=f"Provide a factual, accurate, and concise answer for this web search query: {query}",
        )
...
def web_search(
    ...
    print(f"[WebSearch] [Search] mode={mode!r}  query={query!r}")
